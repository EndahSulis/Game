package id.co.blogspot.endahs738.App12141409;

import java.util.Scanner;

public class App12141409 {
    String nama;
    byte level = 1;
    byte kesempatan = 5;
    short tebak;
    ...
    public void Score() {
        ...
        System.out.println("Qiul\t: 70");
        System.out.println("Rizky\t: 50");
        System.out.println("Dian\t: 100");
        System.out.println("Tiya\t: 100");
    }
    
    public static void main(String[] args) {
        App12141409 main = new App12141409();
